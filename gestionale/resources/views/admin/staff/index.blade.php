...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-users mr-2 text-emerald-600"></i> Gestione Personale
        </h1>
        
        @if(auth()->guard('admin')->user()->hasPermission('create_staff'))
        <button onclick="Livewire.dispatch('openCreateModal')"
                class="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-5 py-2.5 rounded-lg">
