    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">
                <i class="fas fa-concierge-bell mr-2 text-emerald-600"></i> Gestione Servizi
            </h1>
        ...
        <a href="{{ route('admin.services.create') }}" class="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg transition-colors">
