...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.settings.categories.create') }}" 
           class="bg-lime-600 hover:bg-lime-700 text-white px-4 py-2 rounded-lg transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-lg p-12 text-center">
        ...
        @if(auth()->guard('admin')->user()->hasPermission('edit_settings'))
        <a href="{{ route('admin.settings.categories.create') }}" class="mt-4 inline-block text-lime-600 hover:text-lime-700">
