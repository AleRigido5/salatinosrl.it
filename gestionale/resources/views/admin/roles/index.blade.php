    ...
    <div class="flex justify-between items-center mb-6">
        <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('admin.trash.index', 'roles') }}" 
               class="relative inline-flex items-center px-3 py-2 bg-amber-100 hover:bg-amber-200 text-amber-700 rounded-lg transition-all duration-200 text-sm">
                <i class="fas fa-trash-alt mr-1"></i> Cestino
                @if($trashCount > 0)
