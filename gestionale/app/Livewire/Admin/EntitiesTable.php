    ...
    public function viewEntity($id)
    {
        try {
            $entity = Entity::with(['contacts' => function($q) {
                $q->with('setting'); // Carica anche il tipo di contatto
            }])->find($id);
