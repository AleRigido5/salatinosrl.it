...
class StaffTable extends Component
{
    ...
    public function saveStaff()
    {
        if (!empty($this->createCodFiscale)) {
            ...
            if ($existingStaff) {
                $this->dispatch('showError', message: "Codice Fiscale {$this->createCodFiscale} già presente in archivio");
                return;
            }
        }
    ...
    public function goToActivityReport($staffId)
    {
        return redirect()->route('admin.staff.activity-report', $staffId);
    }
    ...
    {
        return view('livewire.admin.staff.staff-table', [
            'staff' => $this->staff,
